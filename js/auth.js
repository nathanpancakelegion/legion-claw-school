/**
 * auth.js â Authentication & Data Helper Functions
 *
...
const MODULES = [
  ...
  { num: 3, title: 'The Prompt Engineering Framework', tier: 'paid' },
...
// Require auth â redirect to login if not authenticated
